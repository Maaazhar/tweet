    ...
    <div key={tweet.id}
      ...
      <div className="flex justify-between">
        ...
        <div>
          {tweet.optionButton &&
            <div>
              <button className="text-md font-medium text-slate-500 p-1.5 rounded-full transition-all duration-300 ease-in-out hover:shadow-[0px_0px_15px] hover:shadow-red-600 hover:bg-transparent"
